...
void shader_program::setCamera(camera& globalCamera,camera& modelLocation) const
{
	...
	glm::mat4 cameraModelRotate = glm::rotate(glm::mat4(), modelLocation.getRotate()->getPosX(), glm::vec3(1.0, 0.0, 0.0)) * glm::rotate(glm::mat4(), modelLocation.getRotate()->getPosY(), glm::vec3(0.0, 1.0, 0.0));
